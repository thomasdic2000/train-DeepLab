...
#    print "result dimensions: ", segm_result.shape   
...
#    result_img.save(result_name)
    ...
    concatenate = True
    segm_name = os.path.basename(img_path).split('.')[0]+'-label3.png'
...
#def help():
#  print('Usage: python deeplab_roof.py GPU_ID NET MODEL IMAGE\n'
